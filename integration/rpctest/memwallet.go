// Copyright (c) 2016-2017 The bchsuite developers
...
func (m *memWallet) fundTx(tx *wire.MsgTx, amt bchutil.Amount, feeRate bchutil.Amount) error {
	const (
...
//
// This function is safe for concurrent access.
func (m *memWallet) CreateTransaction(outputs []*wire.TxOut, feeRate bchutil.Amount) (*wire.MsgTx, error) {
	m.Lock()
	defer m.Unlock()

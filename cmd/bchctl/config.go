...
const (
	...
	unusableFlags = bchjson.UFWebsocketOnly | bchjson.UFNotification
)
...
func listCommands() {
	...
	cmdMethods := bchjson.RegisteredCmdMethods()
	categorized := make([][]string, numCategories)
	for _, method := range cmdMethods {
		flags, err := bchjson.MethodUsageFlags(method)
		if err != nil {
		...
		if flags&bchjson.UFWalletOnly != 0 {

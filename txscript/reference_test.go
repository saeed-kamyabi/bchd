...
func scriptTestName(test []interface{}) (string, error) {
	...
	// The test must consist of at least a signature script, 
        // public key script, flags, and expected error.  Finally, it may optionally 
        // contain a comment.
...
// validate inputs which spend nested programs.

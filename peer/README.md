...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bchsuite/bchd/peer)
...
```bash
$ go get -u github.com/bchsuite/bchd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/bchsuite/bchd/peer#example-package--NewOutboundPeer)  

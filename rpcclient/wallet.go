...
func (r FutureGetTransactionResult) Receive() (*bchjson.GetTransactionResult, error) {
	...
	var getTx bchjson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := bchjson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*bchjson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]bchjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var transactions []bchjson.ListTransactionsResult
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := bchjson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]bchjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := bchjson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]bchjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := bchjson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]bchjson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]bchjson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []bchjson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := bchjson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := bchjson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := bchjson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []bchutil.Address) FutureListUnspentResult {
	...
	cmd := bchjson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]bchjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]bchjson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]bchjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []bchutil.Address) ([]bchjson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*bchjson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult bchjson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = bchjson.String(blockHash.String())
	}

	cmd := bchjson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*bchjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := bchjson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*bchjson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]bchjson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = bchjson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
		}
	}
	cmd := bchjson.NewLockUnspentCmd(unlock, outputs)
	return c.sendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []bchjson.TransactionInput
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := bchjson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFeeAsync(fee bchutil.Amount) FutureSetTxFeeResult {
	cmd := bchjson.NewSetTxFeeCmd(fee.ToBCH())
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddressAsync(address bchutil.Address, amount bchutil.Amount) FutureSendToAddressResult {
	...
	cmd := bchjson.NewSendToAddressCmd(addr, amount.ToBCH(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddressCommentAsync(address bchutil.Address,
	...
	addr := address.EncodeAddress()
	cmd := bchjson.NewSendToAddressCmd(addr, amount.ToBCH(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendFromAsync(fromAccount string, toAddress bchutil.Address, amount bchutil.Amount) FutureSendFromResult {
	...
	cmd := bchjson.NewSendFromCmd(fromAccount, addr, amount.ToBCH(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress bchutil.Address, amount bchutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := bchjson.NewSendFromCmd(fromAccount, addr, amount.ToBCH(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[bchutil.Address]bchutil.Amount) FutureSendManyResult {
	...
	cmd := bchjson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	...
	cmd := bchjson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []bchutil.Address, account string) FutureAddMultisigAddressResult {
	...
	cmd := bchjson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
	return c.sendCmd(cmd)
}
...
func (r FutureCreateMultisigResult) Receive() (*bchjson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes bchjson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []bchutil.Address) FutureCreateMultisigResult {
	...
	cmd := bchjson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []bchutil.Address) (*bchjson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := bchjson.NewCreateNewAccountCmd(account)
	return c.sendCmd(cmd)
}
...
// address.
func (r FutureGetNewAddressResult) Receive() (bchutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := bchjson.NewGetNewAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (r FutureGetRawChangeAddressResult) Receive() (bchutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := bchjson.NewGetRawChangeAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (r FutureGetAccountAddressResult) Receive() (bchutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := bchjson.NewGetAccountAddressCmd(account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetAccountAsync(address bchutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := bchjson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}
...
func (c *Client) SetAccountAsync(address bchutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
	cmd := bchjson.NewSetAccountCmd(addr, account)
	return c.sendCmd(cmd)
}
...
func (r FutureGetAddressesByAccountResult) Receive() ([]bchutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	for _, addrStr := range addrStrings {
		addr, err := bchutil.DecodeAddress(addrStr,
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := bchjson.NewGetAddressesByAccountCmd(account)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount bchutil.Amount) FutureMoveResult {
	cmd := bchjson.NewMoveCmd(fromAccount, toAccount, amount.ToBCH(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	...
	cmd := bchjson.NewMoveCmd(fromAccount, toAccount, amount.ToBCH(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := bchjson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
func (r FutureValidateAddressResult) Receive() (*bchjson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult bchjson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address bchutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := bchjson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given bitcoin address.
func (c *Client) ValidateAddress(address bchutil.Address) (*bchjson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := bchjson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := bchjson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := bchjson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := bchjson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := bchjson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := bchjson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := bchjson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := bchjson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := bchjson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressAsync(address bchutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := bchjson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
func (c *Client) GetReceivedByAddressMinConfAsync(address bchutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := bchjson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]bchjson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []bchjson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := bchjson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]bchjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := bchjson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]bchjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := bchjson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]bchjson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]bchjson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []bchjson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := bchjson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]bchjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := bchjson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// received any payments in the results.
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]bchjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := bchjson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]bchjson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := bchjson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := bchjson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address bchutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := bchjson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyMessageAsync(address bchutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := bchjson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
func (c *Client) DumpPrivKeyAsync(address bchutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := bchjson.NewDumpPrivKeyCmd(addr)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := bchjson.NewImportAddressCmd(address, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, rescan bool) FutureImportAddressResult {
	cmd := bchjson.NewImportAddressCmd(address, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *bchutil.WIF) FutureImportPrivKeyResult {
	...
	cmd := bchjson.NewImportPrivKeyCmd(wif, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *bchutil.WIF, label string) FutureImportPrivKeyResult {
	...
	cmd := bchjson.NewImportPrivKeyCmd(wif, &label, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *bchutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	...
	cmd := bchjson.NewImportPrivKeyCmd(wif, &label, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := bchjson.NewImportPubKeyCmd(pubKey, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := bchjson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.sendCmd(cmd)
}
...
func (r FutureGetInfoResult) Receive() (*bchjson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes bchjson.InfoWalletResult
...
func (c *Client) GetInfo() (*bchjson.InfoWalletResult, error) {
...
// getwalletinfo (NYI in bchwallet or bchjson)

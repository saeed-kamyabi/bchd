...
reason, the bchd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire bchd
...
commits](https://github.com/bchsuite/bchd/commits/master) for examples of
commit messages.
...
Rejoice as you will now be listed as a [contributor](https://github.com/bchsuite/bchd/graphs/contributors)!
...
[ISC license](https://github.com/bchsuite/bchd/blob/master/LICENSE).  This is
the same license as all of the code in the bchd suite.
